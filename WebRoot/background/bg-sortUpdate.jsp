...
<body>
	...
	<div id="bgMain">
		...
		<div id="bgRight">
			<div class="bgRightText font30" style="font-family:黑体">修改商品类别信息</div>
			<form action="SortServlet.do?method=updateSort&sortId=<%=sortId%>" method="post"  name="sortForm" onsubmit="return validate(this)">
			<div class="bgRightForm">
				<div class="bgInput">
					<span class="input5Text">修改名称：</span><input class="input5" name="sortName" type="text"/>
				</div>
				<div class="bgInput">
