...
<body>
	...
	<div id="bgMain">
		...
		<div id="bgRight">
			<div class="bgRightText font30" style="font-family:黑体">添加会员信息</div>
			<form action="MemberServlet.do?method=insertMemberbg" method="post"  name="managerForm" onsubmit="return validate(this)">
			<div class="bgRightForm">
				...
				<div class="bgInput">
					<span class="input5Text">email：</span><input class="input5" name="email" type="text"/>
				</div>
				<div class="bgInput">
					<span class="input5Text">idCard：</span><input class="input5" name="idCard" type="text"/>
				</div>
				<div class="bgInput">
