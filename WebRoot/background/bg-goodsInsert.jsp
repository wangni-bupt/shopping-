			...
			<div class="bgRightTable">
				<table class="tableBorder" style="width:80%;">
							...
							<tr>
								...
								<td style=" width:30%;"><input class="input6" name="bookName" type="text"/></td>
							...
							<tr>
								<td style="background-color:#CCCCCC">出版社</td>
								<td><input name="publisher" type="text" class="input6" /></td>
								<td style="background-color:#CCCCCC">出版时间</td>
