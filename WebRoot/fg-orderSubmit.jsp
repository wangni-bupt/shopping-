...
<body>
	...
	<div id="main">
			<div class="fgText" style="margin-top:0">收银结帐</div>
			<div class="fgText">
			...
			<div class="fgForm">			
				<div class="fgInput">
					<span class="input3Text">订单编号：</span><input class="input3" name="orderId" type="text" value="<%=orderId%>" disabled="disabled"/>
					<input class="input3" name="orderId" type="hidden" value="<%=orderId%>"/><!-- long型的毫秒数     -->
				</div>
				<div class="fgInput">
					<span class="input3Text">会员名称：</span><input class="input3" name="account" type="text" value="<%=form.getAccount()%>" disabled="disabled"/>
					<input class="input3" name="account" type="hidden" value="<%=form.getAccount()%>"/>
				</div>
				<div class="fgInput">
					<span class="input3Text">真实姓名：</span><input class="input3" type="text" name="reallyName" value="<%=form.getReallyName()%>"/>
				</div>
				<div class="fgInput">
					<span class="input3Text">送货地址：</span><select class="select1" name="address">
				...
				<div class="fgInput">
					<span class="input3Text">联系电话：</span><input class="input3" type="text" name="tel"/>
				</div>
				<div class="fgInput">
					<span class="input3Text">付款方式：</span><select class="select1" name="setMoney">
						<option value="">-----------请选择-----------</option>
				...
				<div class="fgInput">
					<span class="input3Text">运输方式：</span><select class="select1" name="post">
						<option value="">-----------请选择-----------</option>
				...
				<div class="fgInput">
					<span class="input3Text">备注信息：</span><input class="input3" type="text" name="bz"/>
				</div>
				<div class="fgInput">		 
